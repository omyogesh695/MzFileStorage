...
SERIAL_SHORTCUTS = {
    ...
    "sairaab": "Sairaab",
    "maharashtrachi hasyajatra": "Maharashtrachi Hasyajatra",
    "hasyajatra": "Maharashtrachi Hasyajatra"
}
...
async def clean_and_parse_filename(name: str, cache: dict = None):
    ...
    # 2. Extract Quality & Codecs directly with Regex
    ...
    # 5. Clean Show Name candidate from junk & subtitles
    junk_words = [
    ...
    matched_show = None
    cand_lower = cleaned_candidate.lower()
    ...
    # Fallback to PTN year if available
